   ...
   while (ros::ok())
    {
		...
		high_cmd_ros.bodyHeight = 0.0;
                high_cmd_ros.yawSpeed = 0.2;			//Speed of rotation whilst walking (left) 0.5 = 45 degrees approx
		high_cmd_ros.footRaiseHeight = 0;
                printf("left_walk\n");
                break;
      	...
      	case 'R':			//turning right
           	...
           	high_cmd_ros.gaitType = 1;			//walk at specified velocity (0= idle, 1=trot, 2=trot running, 3=climb stair, 4=trot obstacle) 	
                high_cmd_ros.velocity[0] = 0.0f; 			// -1  ~ +1
		high_cmd_ros.bodyHeight = 0.0;
                high_cmd_ros.yawSpeed = -0.2;			//Speed of rotation whilst walking (right) -0.5 = 45 degrees approx
		high_cmd_ros.footRaiseHeight = 0;
      	 	printf("right_walk\n");
                break;
